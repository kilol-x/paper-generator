...
const FORMAT_SCHEMA = [
  ...
  { group: 'heading1', label: '一级标题', fields: [
    { key: 'font',        label: '字体',    type: 'text' },
    { key: 'fontSize',    label: '字号',    type: 'number', step: '0.5' },
  ...
  { group: 'abstract', label: '摘要样式', fields: [
    { key: 'titleFont',      label: '标题字体', type: 'text' },
    { key: 'titleFontSize',  label: '标题字号', type: 'number', step: '0.5' },
    { key: 'titleAlignment', label: '标题对齐', type: 'select', options: ['center','left'] },
    { key: 'bodyFont',       label: '正文字体', type: 'text' },
    { key: 'bodyFontSize',   label: '正文字号', type: 'number', step: '0.5' },
    { key: 'lineSpacing',    label: '行间距',   type: 'number', step: '0.1' },
  ]},
  { group: 'references', label: '参考文献', fields: [
    ...
    { key: 'titleFontSize',     label: '标题字号',     type: 'number', step: '0.5' },
    { key: 'titleAlignment',    label: '标题对齐',     type: 'select', options: ['center','left'] },
    { key: 'font',              label: '正文字体',     type: 'text' },
    { key: 'fontSize',          label: '正文字号',     type: 'number', step: '0.5' },
    { key: 'lineSpacing',       label: '行间距',       type: 'number', step: '0.1' },
