...
\begin{document}
	...
	\begin{revrecord}
		...
		\hline
        V1.3 & 2026-07-16 & 郑羽婷 &全组 & 新增部署方案与统一错误码规范，完成终稿 \\
		\hline
	\end{revrecord}
	...
	\begin{enumerate}
		...
		\item 《在线论文文档自动生成工具需求规格说明书》V1.3；
		\item 《在线论文文档自动生成工具概要设计说明书》V1.1；
		\item RFC 7519: JSON Web Token (JWT) 技术标准规范；
        \item Spring Security 架构参考手册 (RBAC与鉴权实现)；
        \item MyBatis-Plus 数据库持久化层开发规范；
        \item 常用办公文档处理技术规范 (Apache POI/iText)。
    \end{enumerate}
